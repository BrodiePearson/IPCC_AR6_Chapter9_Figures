function  IPCC_Plot_Mesh2(mapped_variable, latitude, longitude, ...
...
geoshow(landareas,'FaceColor',ecru,'EdgeColor',[.6 .6 .6]);
...
%     end
    ...
    stipplem(latitude,longitude,stipple_mask,'color',permac,'density',200);
    hold off
end
