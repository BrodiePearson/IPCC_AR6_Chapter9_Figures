function  [vars, latitude, longitude] = IPCC_CMIP6_Load_3D_Field(experiment, variable, ...
    model_names,datapath, start_year, end_year)
%IPCC_CMIP6_Load_3D_Field Function to load 3D IPCC CMIP6 datasets for 2D
%datasets use IPCC_CMIP6_Load
%
%   [vars, latitude, longitude] = IPCC_CMIP6_Load_3D_Field(experiment, variable, ...
%                                        model_names,datapath, start_year, end_year)
%
...
%           star_year - OPTIONAL: start year on file (this is useful if
...
for i=1:length(model_names)
    if contains(char(model_names(i)), 'CNRM-CM6-1') || ...
            ...
            contains(char(model_names(i)), 'GISS-E2-1-G') || ...
