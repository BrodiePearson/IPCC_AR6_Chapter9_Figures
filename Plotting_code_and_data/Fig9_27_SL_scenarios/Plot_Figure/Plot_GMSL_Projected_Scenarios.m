...
for sss=1:length(scens)
    SL_quant{sss}=single(ncread(['data/pbox1e_total_' scens{sss} '_globalsl_figuredata.nc'],'globalSL_quantiles'));
    SL_quantb{sss}=single(ncread(['data/pbox1f_total_' scens{sss} '_globalsl_figuredata.nc'],'globalSL_quantiles'));
...
for sss=[1 4]
    SL_quantLCas{sss}=single(ncread(['data/pbox2e_total_' scens{sss} '_globalsl_figuredata.nc'],'globalSL_quantiles'));
    SL_quantLCbs{sss}=single(ncread(['data/pbox2f_total_' scens{sss} '_globalsl_figuredata.nc'],'globalSL_quantiles'));
