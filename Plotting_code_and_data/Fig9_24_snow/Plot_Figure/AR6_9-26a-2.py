...
with open("data/Mudryk_scf_"+aabeg+"-"+aaend+".txt","r") as f:
    data = f.readlines()
...
plt.savefig(variable+"_NH_"+cmip+"_"+aabeg+"-"+aaend+"_"+titleext+".png")
plt.savefig(variable+"_NH_"+cmip+"_"+aabeg+"-"+aaend+"_"+titleext+".pdf")
plt.show()
