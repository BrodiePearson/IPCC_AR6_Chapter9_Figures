...
%
% Plotting code written by Tim Hermans & Brodie Pearson
% Processed data provided by Tim Hermans
...
% plots Figure 9.32 of AR6 CH9, i.e., the 2050 and 2100 amplification factors which are the output of the FACTS ESL module.
...
%THJ Hermans created: 07-01-2020; last edited: 03-10-2021 (by Brodie Pearson)
...
%set colorbar limits
lim_max = log10(1000);%[-] should be set to correspond to the colorbar ticks hardcoded in IPCC_Plot_Map_9_34.m
lim_min = log10(1);%[-]
...
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, false,'Amplifiation Factor [-]'); hold on;
scatterm(af_ssp126_2050.lat,af_ssp126_2050.lon,40,log10(af_ssp126_2050.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP126_2050.png','-dpng','-r1000', '-painters');
close(1)
%set(gca,'Position',[0.05 0.1 .45 0.3]);
 
%SSP245
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, false,'Amplification Factor [-]'); hold on;
scatterm(af_ssp245_2050.lat,af_ssp245_2050.lon,40,log10(af_ssp245_2050.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP245_2050.png','-dpng','-r1000', '-painters');
close(1)
...
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, false,'Amplification Factor [-]'); hold on;
scatterm(af_ssp585_2050.lat,af_ssp585_2050.lon,40,log10(af_ssp585_2050.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP585_2050.png','-dpng','-r1000', '-painters');
close(1)
...
%SSP126
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, true,'Amplification Factor [-]'); hold on;
scatterm(af_ssp126_2100.lat,af_ssp126_2100.lon,40,log10(af_ssp126_2100.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP126_2100_colorbar.png','-dpng','-r1000', '-painters');
colorbar off
print(gcf,'../PNGs/SSP126_2100.png','-dpng','-r1000', '-painters');
close(1)
...
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, false,'Amplification Factor [-]'); hold on;
scatterm(af_ssp245_2100.lat,af_ssp245_2100.lon,40,log10(af_ssp245_2100.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP245_2100.png','-dpng','-r1000', '-painters');
close(1)
...
IPCC_Plot_Map_9_34(dummy_data',LAT,LON,[lim_min lim_max], ...
    color_bar,'',1,fontsize, false,'Amplification Factor [-]'); hold on;
scatterm(af_ssp585_2100.lat,af_ssp585_2100.lon,40,log10(af_ssp585_2100.af50),'filled','markeredgecolor','k'); hold on;
print(gcf,'../PNGs/SSP585_2100.png','-dpng','-r1000', '-painters');
close(1)
