...
%
% Code used to calculate temperature transects used in Chapter 9
%
...
for ii=1:size(experiments,2)
    ...
    elseif contains(experiments(ii),'ssp')
       ...
       Global_mask(abs(Global_mask)>=0.6) = 1;
       Global_mask(abs(Global_mask)<0.6) = 0;
       ...
       Atlantic_mask(abs(Atlantic_mask)>=0.6) = 1;
       Atlantic_mask(abs(Atlantic_mask)<0.6) = 0;
       ...
       Pacific_mask(abs(Pacific_mask)>=0.6) = 1;
       Pacific_mask(abs(Pacific_mask)<0.6) = 0;
       ...
       Indian_mask(abs(Indian_mask)>=0.6) = 1;
       Indian_mask(abs(Indian_mask)<0.6) = 0;
    ...
    elseif contains(experiments(ii),'hist')
        ...
        Global_bias_mask(abs(Global_bias_mask)>=0.6) = 1;
        Global_bias_mask(abs(Global_bias_mask)<0.6) = 0;
        ...
        Pacific_bias_mask(abs(Pacific_bias_mask)>=0.6) = 1;
        Pacific_bias_mask(abs(Pacific_bias_mask)<0.6) = 0;
        ...
        Atlantic_bias_mask(abs(Atlantic_bias_mask)>=0.6) = 1;
        Atlantic_bias_mask(abs(Atlantic_bias_mask)<0.6) = 0;
        ...
        Indian_bias_mask(abs(Indian_bias_mask)>=0.6) = 1;
        Indian_bias_mask(abs(Indian_bias_mask)<0.6) = 0;
...
save('./Processed_Data/Temperature_Transects.mat', 'Indian_observations',...
