...
%
% Code used to plot pre-processed timeseries of Antarctic mass balance. 
%
% Plotting code written by Brodie Pearson & Baylor Fox-Kemper
% Processed data provided by Tamzin Edwards
...
IMBIE_data=xlsread('./Processed_Data/IMBIE_AR6.xlsx');
...
IMBIE_data_p=csvread('./Processed_Data/apis_dm.csv');
...
IMBIE_data_e=csvread('./Processed_Data/eais_dm.csv');
...
IMBIE_data_w=csvread('./Processed_Data/wais_dm.csv');
...
EMU_New_585= double(ncread('./Processed_Data/AIS_emulated_projections/icesheets-ipccar6-ismipemuicesheet-ssp585_AIS_globalsl_figuredata.nc','globalSL_quantiles'));
EMU_New_370= double(ncread('./Processed_Data/AIS_emulated_projections/icesheets-ipccar6-ismipemuicesheet-ssp370_AIS_globalsl_figuredata.nc','globalSL_quantiles'));
EMU_New_245= double(ncread('./Processed_Data/AIS_emulated_projections/icesheets-ipccar6-ismipemuicesheet-ssp245_AIS_globalsl_figuredata.nc','globalSL_quantiles'));
EMU_New_126= double(ncread('./Processed_Data/AIS_emulated_projections/icesheets-ipccar6-ismipemuicesheet-ssp126_AIS_globalsl_figuredata.nc','globalSL_quantiles'));
Emu_New_Time = ncread('./Processed_Data/AIS_emulated_projections/icesheets-ipccar6-ismipemuicesheet-ssp126_AIS_globalsl_figuredata.nc','years');
...
Rignot_data=textread('./Processed_Data/Rignot_AA_CMB.txt');
...
file_RIGNOT='./Processed_Data/Rignot_Update_Antarctica.xlsx'
