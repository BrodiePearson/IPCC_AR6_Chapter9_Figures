...
plot([3.5,3.5], [-1.77, -1.77], 'o-', 'MarkerSize',15, 'LineWidth', width/2,'MarkerEdgeColor', color_OBS,'Color', color_OBS)
plot([3.5,3.5], [-4.33, 0.21], '-', 'LineWidth', width/2,'MarkerEdgeColor', color_OBS,'Color', color_OBS) % 22kyr BP- Present
plot([.5,.5], [SST_LIG_mn, SST_LIG_mn], 'o-','MarkerEdgeColor', color_CMIP,'Color', color_CMIP, 'MarkerSize',15, 'LineWidth', width/2) % PMIP
plot([.5,.5], [SST_LIG_mn+SST_LIG_std, SST_LIG_mn - SST_LIG_std] ...
    , '-','MarkerEdgeColor', color_CMIP, 'MarkerSize',15,'Color', color_CMIP, 'LineWidth', width/2) % PMIP
plot([2,2], [SST_mHOL_mn, SST_mHOL_mn], 'o-','MarkerEdgeColor', color_CMIP, 'MarkerSize',15,'Color', color_CMIP, 'LineWidth', width/2) % PMIP
plot([2,2], [SST_mHOL_mn+SST_mHOL_std, SST_mHOL_mn - SST_mHOL_std] ...
    , '-','MarkerEdgeColor', color_CMIP, 'MarkerSize',15,'Color', color_CMIP, 'LineWidth', width/2) % PMIP
plot([3.5,3.5], [SST_mPLI_mn, SST_mPLI_mn], 'o-','MarkerEdgeColor', color_CMIP, 'MarkerSize',15,'Color', color_CMIP, 'LineWidth', width/2) % PMIP
